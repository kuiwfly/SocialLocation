...
public class URLs implements Serializable {
	...
	public final static String URL_API_VALIDATEUSERNAME = URL_API_HOST+"ValidateUserName" ;
	
	
	public final static String LOGIN_VALIDATE_HTTP = HTTP + HOST + URL_SPLITTER + "LocationShare/LogIn";
	public final static String LOGIN_VALIDATE_HTTPS = HTTPS + HOST + URL_SPLITTER + "LocationShare/LogIn";
	
	public final static String SIGNUP_VALIDATE_HTTP = HTTP + HOST + URL_SPLITTER + "LocationShare/SignUp";
	public final static String SIGNUP_VALIDATE_HTTPS = HTTPS + HOST + URL_SPLITTER + "LocationShare/SignUp";
	
	public final static String RECORDEXCEPTION_VALIDATE_HTTP = HTTP + HOST + URL_SPLITTER + "LocationShare/RecordException";
	public final static String RECORDEXCEPTION_VALIDATE_HTTPS = HTTPS + HOST + URL_SPLITTER + "LocationShare/RecordException";
	
	public final static String GET_USER_DETAIL_HTTP = HTTP + HOST + URL_SPLITTER + "LocationShare/GetUserDetail";
	public final static String GET_USER_DETAIL_HTTPS = HTTPS + HOST + URL_SPLITTER + "LocationShare/GetUserDetail";
	
	public final static String UPDATE_PORTRAIT_HTTP = HTTP + HOST + URL_SPLITTER + "LocationShare/UpdateHeadPortrait";
	public final static String UPDATE_PORTRAIT_HTTPS = HTTPS + HOST + URL_SPLITTER + "LocationShare/UpdateHeadPortrait";
