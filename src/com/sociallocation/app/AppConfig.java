...
import com.sociallocation.bean.AccessInfo;
...
public class AppConfig {
	...
	public void setAccessInfo(String accessToken, String accessSecret,
		...
		// 保存到配�?		this.setAccessToken(accessToken);
	...
	private void setProps(Properties p) {
		...
		try {
			// 把config建在files目录�?			// fos = activity.openFileOutput(APP_CONFIG, Context.MODE_PRIVATE);
